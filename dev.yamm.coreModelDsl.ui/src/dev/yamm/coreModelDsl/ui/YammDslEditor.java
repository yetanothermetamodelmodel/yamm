...
import dev.yamm.coreModelDsl.ui.editor.XYammEditor;

public class YammDslEditor extends XYammEditor
{

	private dev.yamm.coreModelDiagram.yammDiagram.YModel yModelDiagram;
...
//							if ((modelName + ".yammdiagram").equals(semRes.getURI().lastSegment()))
//							{
//								yModelDiagram = (dev.yamm.coreModelDiagram.yammDiagram.YModel) semRes.getContents()
//										.get(0);
//							}
//						}
//					}
...
//						if (diagram.getTarget() instanceof dev.yamm.coreModelDiagram.yammDiagram.YModel)
//						{
//							DialectUIManager.INSTANCE.openEditor(session, diagram, new NullProgressMonitor());
//							yModelDiagram = (dev.yamm.coreModelDiagram.yammDiagram.YModel) diagram.getTarget();
//							break;
//						}
//					}
//				}
