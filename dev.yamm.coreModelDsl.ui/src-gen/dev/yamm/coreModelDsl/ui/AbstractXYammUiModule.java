...
import dev.yamm.coreModelDsl.ide.contentassist.antlr.PartialXYammContentAssistParser;
import dev.yamm.coreModelDsl.ide.contentassist.antlr.XYammParser;
import dev.yamm.coreModelDsl.ide.contentassist.antlr.internal.InternalXYammLexer;
import dev.yamm.coreModelDsl.ui.contentassist.XYammProposalProvider;
import dev.yamm.coreModelDsl.ui.editor.XYammEditor;
import dev.yamm.coreModelDsl.ui.labeling.XYammDescriptionLabelProvider;
import dev.yamm.coreModelDsl.ui.labeling.XYammLabelProvider;
import dev.yamm.coreModelDsl.ui.outline.XYammOutlineTreeProvider;
import dev.yamm.coreModelDsl.ui.quickfix.XYammQuickfixProvider;
...
/**
 * Manual modifications go to {@link XYammUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractXYammUiModule extends DefaultXbaseUiModule {

	public AbstractXYammUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(dev.yamm.coreModelDsl.parser.antlr.internal.InternalXYammLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalXYammLexer.class).toProvider(LexerProvider.create(InternalXYammLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return XYammLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(XYammDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return XYammOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return XYammQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return XYammProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialXYammContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("XYamm Compare");
	}
