 ...
 */
package online.yamm.util.evalGrammar.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import online.yamm.util.evalGrammar.ide.contentassist.antlr.internal.InternalEvalParser;
import online.yamm.util.evalGrammar.services.EvalGrammarAccess;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class EvalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(EvalGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EvalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getExpressionAssignment(), "rule__Model__ExpressionAssignment");
	...
	@Override
	protected InternalEvalParser createParser() {
		InternalEvalParser result = new InternalEvalParser(null);
