...
:
	(
		{ before(grammarAccess.getModelAccess().getExpressionXBlockExpressionParserRuleCall_0()); }
		ruleXBlockExpression
		{ after(grammarAccess.getModelAccess().getExpressionXBlockExpressionParserRuleCall_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
