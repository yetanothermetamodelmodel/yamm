...
/**
 * This is the item provider adapter for a {@link targetAST.T_DesEventQueueConsume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_DesEventQueueConsumeItemProvider extends T_ExpLevelAItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public T_DesEventQueueConsumeItemProvider(AdapterFactory adapterFactory)
	{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TDES_EVENT_QUEUE_CONSUME__ARGUMENTS);
		}
	...
	/**
	 * This returns T_DesEventQueueConsume.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_DesEventQueueConsume"));
	}
	...
	{
		String label = ((T_DesEventQueueConsume)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_T_DesEventQueueConsume_type") :
			getString("_UI_T_DesEventQueueConsume_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(T_DesEventQueueConsume.class)) {
			case TargetASTPackage.TDES_EVENT_QUEUE_CONSUME__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TDES_EVENT_QUEUE_CONSUME__ARGUMENTS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TDES_EVENT_QUEUE_CONSUME__ARGUMENTS;
