...
import dev.yamm.example.dfa.dfa.DFinalState;
import dev.yamm.example.dfa.dfa.DInitialFinalState;
...
public class DfaPackageImpl extends EPackageImpl implements DfaPackage {
	 ...
	 * @see dev.yamm.example.dfa.dfa.DfaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(dfaEClass, dev.yamm.example.dfa.dfa.DFA.class, "DFA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDFA_Transitions(), this.getDTransition(), null, "transitions", null, 1, -1, dev.yamm.example.dfa.dfa.DFA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDFA_States(), this.getDState(), null, "states", null, 1, -1, dev.yamm.example.dfa.dfa.DFA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDFA_InitialState(), this.getDInitialState(), null, "initialState", null, 1, 1, dev.yamm.example.dfa.dfa.DFA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
