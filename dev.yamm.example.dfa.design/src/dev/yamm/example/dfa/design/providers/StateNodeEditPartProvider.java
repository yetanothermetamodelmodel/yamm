 ...
 * 
 */
package dev.yamm.example.dfa.design.providers;
...
import dev.yamm.example.dfa.design.editParts.StateNodeEditPart;
import dev.yamm.example.dfa.dfa.DState;

public class StateNodeEditPartProvider extends AbstractEditPartProvider {
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (dElement instanceof DSemanticDecorator) {
				...
				if (target instanceof DState && view.getType().equals("2001")) {
					return true;
				}
			}
		}
