 ...
 * @generated
 */
public class T_ExtTypeTest extends T_ExpLevelBTest {
	...
	public static void main(String[] args) {
		TestRunner.run(T_ExtTypeTest.class);
	}
	 ...
	 * @generated
	 */
	public T_ExtTypeTest(String name) {
		super(name);
	}
	 ...
	 */
	@Override
	protected T_ExtType getFixture() {
		return (T_ExtType)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(TargetASTFactory.eINSTANCE.createT_ExtType());
	}
