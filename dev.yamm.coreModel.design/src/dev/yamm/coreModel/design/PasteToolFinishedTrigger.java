...
public class PasteToolFinishedTrigger implements ModelChangeTrigger
{
	private Session session;
	
	public PasteToolFinishedTrigger(Session session) 
	{
	...
	{		
		RecordingCommand cmd = new RecordingCommand(session.getTransactionalEditingDomain()) 
		{
			...
			{
				Services.pasteRmofSwitch.customizeCopiedElements();	
			}
		};
