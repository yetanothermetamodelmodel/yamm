...
import dev.yamm.chen.design.editPart.RelationshipEditPart;

public class RelationshipEditpartProvider extends AbstractEditPartProvider {
	@Override
	public boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (dElement instanceof DSemanticDecorator) {
				...
				if (target instanceof Relationship && view.getType().equals("2001")) {	
					return true;
				}
			}
		}
