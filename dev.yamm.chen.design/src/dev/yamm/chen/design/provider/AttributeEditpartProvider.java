...
import dev.yamm.chen.design.editPart.AttributeEditPart;

public class AttributeEditpartProvider  extends AbstractEditPartProvider {
	@Override
	public boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (dElement instanceof DSemanticDecorator) {
				...
				if (target instanceof Attribute && view.getType().equals("2001")) {
					return true;
				}
			}
		}
