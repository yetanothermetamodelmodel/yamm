...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>yamm</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class YammExample
{
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args)
	{
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.yamm"));
				YClass root = YammFactory.eINSTANCE.createYClass();
