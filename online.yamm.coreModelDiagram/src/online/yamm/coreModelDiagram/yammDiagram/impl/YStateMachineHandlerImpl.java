 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getState <em>State</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#isIsSuspended <em>Is Suspended</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getEffectCount <em>Effect Count</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getEffectNo <em>Effect No</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getCalledFrom <em>Called From</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getItsClassID <em>Its Class ID</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getOperationInstance <em>Operation Instance</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getEffectsProcessed <em>Effects Processed</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getMaxEffectsToBeProcessed <em>Max Effects To Be Processed</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getInAdapters <em>In Adapters</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getObjectsBindedWithInoutParameters <em>Objects Binded With Inout Parameters</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getReturnVar <em>Return Var</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getNameOfRetunVar <em>Name Of Retun Var</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineHandlerImpl#getObjectsToColor <em>Objects To Color</em>}</li>
 * </ul>
 *
 * @generated
 */
