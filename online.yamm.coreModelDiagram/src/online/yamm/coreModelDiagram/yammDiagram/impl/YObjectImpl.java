 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YObjectImpl#getObjectID <em>Object ID</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YObjectImpl#getDslInfo <em>Dsl Info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YObjectImpl extends MinimalEObjectImpl.Container implements YObject
{
	...
	{
		return YammDiagramPackage.Literals.YOBJECT;
	}
	...
	public void setObjectID(String newObjectID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YOBJECT__OBJECT_ID, oldObjectID, objectID, !oldObjectIDESet));
	}
	...
	public void unsetObjectID()
	{
		...
		objectIDESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, YammDiagramPackage.YOBJECT__OBJECT_ID, oldObjectID, OBJECT_ID_EDEFAULT, oldObjectIDESet));
	}
	...
	public DslInfo getDslInfo()
	{
		if (dslInfo != null && dslInfo.eIsProxy()) {
			...
			if (dslInfo != oldDslInfo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YOBJECT__DSL_INFO, oldDslInfo, dslInfo));
			}
		}
		return dslInfo;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			case YammDiagramPackage.YOBJECT__OBJECT_ID:
				return getObjectID();
			case YammDiagramPackage.YOBJECT__DSL_INFO:
