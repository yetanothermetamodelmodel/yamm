 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.EStructuralFeatureToFeatureInfoMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.EStructuralFeatureToFeatureInfoMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EStructuralFeatureToFeatureInfoMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<EStructuralFeature,FeatureInfo>
{
	...
	{
		return YammDiagramPackage.Literals.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP;
	}
		...
		if (key != null && key.eIsProxy()) {
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__KEY, oldKey, key));
			}
		}
		return key;
	}
	...
	public void setTypedKey(EStructuralFeature newKey)
	{
		...
		key = newKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__KEY, oldKey, key));
	}
	...
	public FeatureInfo getTypedValue()
	{
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setTypedValue(FeatureInfo newValue)
	{
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__VALUE, oldValue, value));
	}
	...
	{
		switch (featureID) {
			case YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__KEY:
				if (resolve) return getTypedKey();
				return basicGetTypedKey();
			case YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP__VALUE:
