 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.ContainmentInfoImpl#getInsertionLine <em>Insertion Line</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainmentInfoImpl extends FeatureInfoImpl implements ContainmentInfo
{
	...
	{
		return YammDiagramPackage.Literals.CONTAINMENT_INFO;
	}
		...
		if (insertionLine != null && insertionLine.eIsProxy()) {
			...
			if (insertionLine != oldInsertionLine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.CONTAINMENT_INFO__INSERTION_LINE, oldInsertionLine, insertionLine));
			}
		}
	...
	public void setInsertionLine(Line newInsertionLine)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.CONTAINMENT_INFO__INSERTION_LINE, oldInsertionLine, insertionLine));
	}
	...
	{
		switch (featureID) {
			case YammDiagramPackage.CONTAINMENT_INFO__INSERTION_LINE:
