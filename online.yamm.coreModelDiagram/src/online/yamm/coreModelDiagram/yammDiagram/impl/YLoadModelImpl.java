 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelDiagram.yammDiagram.impl.YLoadModelImpl#getRelModelPath <em>Rel Model Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YLoadModelImpl extends XExpressionImpl implements YLoadModel
{
	...
	{
		return YammDiagramPackage.Literals.YLOAD_MODEL;
	}
	...
	public NotificationChain basicSetRelModelPath(XExpression newRelModelPath, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YLOAD_MODEL__REL_MODEL_PATH, oldRelModelPath, newRelModelPath);
	...
	public void setRelModelPath(XExpression newRelModelPath)
	{
		if (newRelModelPath != relModelPath) {
			...
			if (relModelPath != null)
				msgs = ((InternalEObject)relModelPath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - YammDiagramPackage.YLOAD_MODEL__REL_MODEL_PATH, null, msgs);
			if (newRelModelPath != null)
				msgs = ((InternalEObject)newRelModelPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - YammDiagramPackage.YLOAD_MODEL__REL_MODEL_PATH, null, msgs);
			msgs = basicSetRelModelPath(newRelModelPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YLOAD_MODEL__REL_MODEL_PATH, newRelModelPath, newRelModelPath));
	}
