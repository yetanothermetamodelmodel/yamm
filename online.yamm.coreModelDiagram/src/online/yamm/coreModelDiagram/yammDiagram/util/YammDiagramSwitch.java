 ...
 * @generated
 */
public class YammDiagramSwitch<T> extends Switch<T>
{
	/**
	...
	{
		switch (classifierID) {
			case YammDiagramPackage.YCLASS: {
			...
			case YammDiagramPackage.YCLASSIFIER: {
			...
			case YammDiagramPackage.YCOMMENT: {
			...
			case YammDiagramPackage.YCONSTRAINT: {
			...
			case YammDiagramPackage.YDATA_TYPE: {
			...
			case YammDiagramPackage.YELEMENT: {
			...
			case YammDiagramPackage.YELEMENT_IMPORT: {
			...
			case YammDiagramPackage.YENUMERATION: {
			...
			case YammDiagramPackage.YENUMERATION_LITERAL: {
			...
			case YammDiagramPackage.YFEATURE: {
			...
			case YammDiagramPackage.YNAMED_ELEMENT: {
			...
			case YammDiagramPackage.YNAMESPACE: {
			...
			case YammDiagramPackage.YOPERATION: {
			...
			case YammDiagramPackage.YPACKAGE: {
			...
			case YammDiagramPackage.YPACKAGEABLE_ELEMENT: {
			...
			case YammDiagramPackage.YPACKAGE_IMPORT: {
			...
			case YammDiagramPackage.YPARAMETER: {
			...
			case YammDiagramPackage.YPRIMITIVE_TYPE: {
			...
			case YammDiagramPackage.YPROPERTY: {
			...
			case YammDiagramPackage.YSTATE_MACHINE: {
			...
			case YammDiagramPackage.YTRANSITION: {
			...
			case YammDiagramPackage.YTR_ATTACHMENT: {
			...
			case YammDiagramPackage.YEFFECT: {
			...
			case YammDiagramPackage.YVERTEX: {
			...
			case YammDiagramPackage.YPSEUDOSTATE: {
			...
			case YammDiagramPackage.YFINAL_STATE: {
			...
			case YammDiagramPackage.YSTATE: {
			...
			case YammDiagramPackage.YMODEL: {
			...
			case YammDiagramPackage.YSHARED_EDGE: {
			...
			case YammDiagramPackage.YCOMPOSITE_EDGE: {
			...
			case YammDiagramPackage.YOBJECT: {
				YObject yObject = (YObject)theEObject;
				T result = caseYObject(yObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YammDiagramPackage.YSTATE_MACHINE_HANDLER: {
			...
			case YammDiagramPackage.YGLOBAL_STATE_MACHINE: {
			...
			case YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION: {
			...
			case YammDiagramPackage.YPRINT_EXPRESSION: {
			...
			case YammDiagramPackage.YSET_RETURN_VALUE: {
			...
			case YammDiagramPackage.YGET_INSTANCES_OF_EXPRESSION: {
			...
			case YammDiagramPackage.YMEMBER_FEATURE_CALL: {
			...
			case YammDiagramPackage.YFEATURE_CALL: {
			...
			case YammDiagramPackage.YGET_OBJECT_MANAGEMENT: {
			...
			case YammDiagramPackage.YGET_LAYER_INFORMATION: {
			...
			case YammDiagramPackage.YCOLOR_DFA_OBJECT: {
			...
			case YammDiagramPackage.YGET_INSTANCES: {
			...
			case YammDiagramPackage.YCOUNT_FINAL_STATES: {
			...
			case YammDiagramPackage.YCOUNT_INITIAL_STATES: {
			...
			case YammDiagramPackage.YCOUNT_STATES: {
			...
			case YammDiagramPackage.YSET_ABSOLUTE_NODE_PROPABILITY: {
			...
			case YammDiagramPackage.YCOUNT_REACHABLE_STATES: {
			...
			case YammDiagramPackage.YCOUNT_IN_VALID_TRANSITIONS: {
			...
			case YammDiagramPackage.YSET_POPULATION_SIZE: {
			...
			case YammDiagramPackage.YLOAD_MODEL: {
			...
			case YammDiagramPackage.GUARD_INFO: {
			...
			case YammDiagramPackage.EFFECT_INFO: {
			...
			case YammDiagramPackage.CONTAINMENT_INFO: {
			...
			case YammDiagramPackage.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP: {
			...
			case YammDiagramPackage.LINE: {
				Line line = (Line)theEObject;
				T result = caseLine(line);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YammDiagramPackage.YSTRUCTURE: {
				YStructure yStructure = (YStructure)theEObject;
				T result = caseYStructure(yStructure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YammDiagramPackage.YOBSERVER_ADD_VALUE: {
