...
/**
 * This is the item provider adapter for a {@link online.yamm.chen.chen.Generalization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneralizationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Generalization_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Generalization_type_feature", "_UI_Generalization_type"),
				 ChenPackage.Literals.GENERALIZATION__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Type labelValue = ((Generalization)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Generalization.class)) {
			case ChenPackage.GENERALIZATION__TYPE:
