 ...
 */
package dev.yamm.util.evalGrammar.jvmmodel
...
class EvalJvmModelInferrer extends AbstractModelInferrer {
	...
	def getParameterTyp(EObject element){
		...
		entryRef.type = jdtTypesProviderFactory.findOrCreateTypeProvider(element.eResource().getResourceSet()).findTypeByName("dev.yamm.gui.TimeToValue");
