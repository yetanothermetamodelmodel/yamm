 ...
 */
package dev.yamm.util.evalGrammar.services;
...
public class EvalGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dev.yamm.util.evalGrammar.Eval.Model");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("dev.yamm.util.evalGrammar.Eval".equals(grammar.getName())) {
				return grammar;
			}
