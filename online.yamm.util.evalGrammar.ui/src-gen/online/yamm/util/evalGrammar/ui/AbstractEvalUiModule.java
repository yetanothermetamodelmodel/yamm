...
import online.yamm.util.evalGrammar.ide.contentassist.antlr.PartialEvalContentAssistParser;
import online.yamm.util.evalGrammar.ide.contentassist.antlr.internal.InternalEvalLexer;
import online.yamm.util.evalGrammar.ui.contentassist.EvalProposalProvider;
import online.yamm.util.evalGrammar.ui.editor.EvalEditor;
import online.yamm.util.evalGrammar.ui.labeling.EvalDescriptionLabelProvider;
import online.yamm.util.evalGrammar.ui.labeling.EvalLabelProvider;
import online.yamm.util.evalGrammar.ui.outline.EvalOutlineTreeProvider;
import online.yamm.util.evalGrammar.ui.quickfix.EvalQuickfixProvider;
...
/**
 * Manual modifications go to {@link EvalUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractEvalUiModule extends DefaultXbaseUiModule {

	public AbstractEvalUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(online.yamm.util.evalGrammar.parser.antlr.internal.InternalEvalLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalEvalLexer.class).toProvider(LexerProvider.create(InternalEvalLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return EvalLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(EvalDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return EvalOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return EvalQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return EvalProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialEvalContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Eval Compare");
	}
