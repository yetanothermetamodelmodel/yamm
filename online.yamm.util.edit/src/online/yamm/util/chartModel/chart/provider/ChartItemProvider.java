...
/**
 * This is the item provider adapter for a {@link online.yamm.util.chartModel.chart.Chart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addChartIdPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chart_yTitle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chart_yTitle_feature", "_UI_Chart_type"),
				 ChartPackage.Literals.CHART__YTITLE,
				 true,
				 false,
				 false,
	...
	protected void addXTitlePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chart_xTitle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chart_xTitle_feature", "_UI_Chart_type"),
				 ChartPackage.Literals.CHART__XTITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Chart Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addChartIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chart_chartId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chart_chartId_feature", "_UI_Chart_type"),
				 ChartPackage.Literals.CHART__CHART_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	{
		String label = ((Chart)object).getYTitle();
		...
		newChildDescriptors.add
			(createChildParameter
				(ChartPackage.Literals.CHART__SERIES,
				 ChartFactory.eINSTANCE.createSeries()));
	}
