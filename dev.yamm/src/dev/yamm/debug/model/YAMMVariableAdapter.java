...
import dev.yamm.gui.SimulationIsRunning;
...
public class YAMMVariableAdapter extends EContentAdapter { 
	...
	/** The logger */
	public static dev.yamm.logger.YAMMLogger logger = YAMMLogger.getYAMMLogger("YAMM Log");
	 ...
	 * Is also called directly by {@link dev.yamm.Zerochart #keepDebugModelUpToDate} when the operation
