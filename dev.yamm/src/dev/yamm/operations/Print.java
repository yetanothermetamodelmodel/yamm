...
public class Print {
	...
	public Print(EvalGuardOrEffect execute) {
		this.execute = execute;
	}

	public void printOut(String value, int layer) {
		if(layer == 0) {
			return;
		}
		...
		logger.info("(Message) [layer "+layer+"] of " + value + " : "+execute.getValue.getValue(value, layer));
	}
}
