 ...
 * When a new YAMM example project has been created by means of the {@link dev.yamm.gui.YAMMWizard}
...
public class YAMMExampleProjectStore 
{
	public static String geldautomatExample() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" + 
				"<yammDiagram:YModel xmi:version=\"2.0\" xmlns:xmi=\"http://www.omg.org/XMI\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:yammDiagram=\"http://www.yamm.dev/coreModelDiagram/YammDiagram\">\r\n" + 
				...
				"            <effects ObjectID=\"f6420ae\" effectStringRep=\"(var_objectManagment as dev.yamm.ObjectManagement).addQueueElement(this, object, 1);\"/>\r\n" + 
				"          </trAttach>\r\n" + 
				"        </stateMachine>\r\n" + 
				"      </ownedOperation>\r\n" + 
				...
				"            <effects ObjectID=\"f3726ea\" effectStringRep=\"(var_objectManagment as dev.yamm.ObjectManagement).addDelayedQueueElement(this, object, 1);\"/>\r\n" + 
				...
				"            <effects ObjectID=\"fe6655\" effectStringRep=\"(var_objectManagment as dev.yamm.ObjectManagement).removeDelayedQueueElement(this, event.objectAttached, 1);\"/>\r\n" + 
	...
	public static String tagungsplanung() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" + 
				"<yammDiagram:YModel xmi:version=\"2.0\" xmlns:xmi=\"http://www.omg.org/XMI\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:yammDiagram=\"http://www.yamm.dev/coreModelDiagram/YammDiagram\">\r\n" + 
				"  <clazz ObjectID=\"f5e24a2\" name=\"RObject\">\r\n" + 
				"    <ownedAttribute ObjectID=\"f2bd771\" name=\"rContainer\" type=\"//@clazz.0\" clazz=\"//@clazz.0\" />\r\n" + 
	...
	public static String desGravelShippingExample()
	{
		final String GRAVEL_SHIPPING = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
				...
				"          <effects ObjectID=\"f23277e\" effectStringRep=\"chartView = new dev.yamm.util.YammChartView(&quot;QueueWeighingStation&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f261d9f\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).addChart(yammInternal as org.eclipse.emf.ecore.EObject, &quot;simulationTime&quot;, &quot;time&quot;, this, &quot;queue&quot;, &quot;queueWS&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f1ee59c\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).addChart(yammInternal as org.eclipse.emf.ecore.EObject, &quot;simulationTime&quot;, &quot;time&quot;, this, &quot;delayed&quot;, &quot;delayed&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f3d4bbb\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).showCharts;\"/>\n" + 
				"        </trAttach>\n" + 
				"      </stateMachine>\n" + 
				"    </ownedOperation>\n" + 
				"  </clazz>\n" + 
				...
				"          <effects ObjectID=\"f599212\" effectStringRep=\"chartView = new dev.yamm.util.YammChartView(&quot;GravelToShip&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f7a5c95\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).addChart(yammInternal as org.eclipse.emf.ecore.EObject, &quot;simulationTime&quot;, &quot;time&quot;, this, &quot;_gravelToShip&quot;, &quot;gravelToShip&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f4dd3cc\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).showCharts;&#xA;\"/>\n" + 
				"        </trAttach>\n" + 
				...
				"          <effects ObjectID=\"f7675a9\" effectStringRep=\"chartView = new dev.yamm.util.YammChartView(&quot;QueueLoadingDock&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f69a05e\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).addChart(yammInternal as org.eclipse.emf.ecore.EObject, &quot;simulationTime&quot;, &quot;time&quot;, this, &quot;queue&quot;, &quot;queueLD&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f45f43d\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).addChart(yammInternal as org.eclipse.emf.ecore.EObject, &quot;simulationTime&quot;, &quot;time&quot;, this, &quot;delayed&quot;, &quot;delayed&quot;);\"/>\n" + 
				"          <effects ObjectID=\"f1cbeb7\" effectStringRep=\"(chartView as dev.yamm.util.YammChartView).showCharts;\"/>\n" + 
				"        </trAttach>\n" + 
				"      </stateMachine>\n" + 
				"    </ownedOperation>\n" + 
				"  </clazz>\n" + 
