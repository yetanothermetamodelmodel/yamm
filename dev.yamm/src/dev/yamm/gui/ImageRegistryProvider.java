...
/**
 * A class granting access to the Image Registry of {@link dev.yamm.init.Activator}.
...
{	
	...
	{
		ImageDescriptor imageDescriptor = dev.yamm.init.Activator.getImageDescriptor(key);
