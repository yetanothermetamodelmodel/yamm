...
/**
 * This is the item provider adapter for a {@link online.yamm.markov.markov.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends RObjectItemProvider
{
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MarkovPackage.Literals.TRANSITION__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MarkovPackage.Literals.TRANSITION__TO,
				 true,
				 false,
				 true,
				 null,
	...
	{
		String label = ((Transition)object).getObjectID();
