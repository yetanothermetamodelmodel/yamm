...
import dev.yamm.coreModelDiagram.yammDiagram.YGlobalStateMachine;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getStateMachines <em>State Machines</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getStateMachineHandlers <em>State Machine Handlers</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getStateMachineHandlerCount <em>State Machine Handler Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#isConstraintsAllTrue <em>Constraints All True</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#isHasReturnParam <em>Has Return Param</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getParamCount <em>Param Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getStateExitCount <em>State Exit Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getStateExitNo <em>State Exit No</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#getO <em>O</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YGlobalStateMachineImpl#isObserverActive <em>Observer Active</em>}</li>
 * </ul>
 *
 * @generated
 */
