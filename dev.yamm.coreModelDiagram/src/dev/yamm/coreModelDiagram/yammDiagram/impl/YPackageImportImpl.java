...
import dev.yamm.coreModelDiagram.yammDiagram.YPackageImport;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YPackageImportImpl#getImportedPackage <em>Imported Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YPackageImportImpl#getImportingNamespace <em>Importing Namespace</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YPackageImportImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YPackageImportImpl#getOwnedElement <em>Owned Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YPackageImportImpl extends YElementImpl implements YPackageImport
{
	...
	{
		return YammDiagramPackage.Literals.YPACKAGE_IMPORT;
	}
		...
		if (importedPackage != null && importedPackage.eIsProxy()) {
			...
			if (importedPackage != oldImportedPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YPACKAGE_IMPORT__IMPORTED_PACKAGE, oldImportedPackage, importedPackage));
			}
		}
	...
	public void setImportedPackage(YPackage newImportedPackage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YPACKAGE_IMPORT__IMPORTED_PACKAGE, oldImportedPackage, importedPackage));
	}
	...
	public YNamespace getImportingNamespace()
	{
		if (importingNamespace != null && importingNamespace.eIsProxy()) {
			...
			if (importingNamespace != oldImportingNamespace) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YPACKAGE_IMPORT__IMPORTING_NAMESPACE, oldImportingNamespace, importingNamespace));
			}
		}
	...
	public void setImportingNamespace(YNamespace newImportingNamespace)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YPACKAGE_IMPORT__IMPORTING_NAMESPACE, oldImportingNamespace, importingNamespace));
	}
	...
	public NotificationChain basicSetOwnedComment(YComment newOwnedComment, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YPACKAGE_IMPORT__OWNED_COMMENT, oldOwnedComment, newOwnedComment);
	...
	public void setOwnedComment(YComment newOwnedComment)
	{
		if (newOwnedComment != ownedComment) {
			...
			if (ownedComment != null)
				msgs = ((InternalEObject)ownedComment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - YammDiagramPackage.YPACKAGE_IMPORT__OWNED_COMMENT, null, msgs);
			if (newOwnedComment != null)
				msgs = ((InternalEObject)newOwnedComment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - YammDiagramPackage.YPACKAGE_IMPORT__OWNED_COMMENT, null, msgs);
			msgs = basicSetOwnedComment(newOwnedComment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YPACKAGE_IMPORT__OWNED_COMMENT, newOwnedComment, newOwnedComment));
	}
	...
	public EList<YElement> getOwnedElement()
	{
		if (ownedElement == null) {
			ownedElement = new EObjectContainmentEList<YElement>(YElement.class, this, YammDiagramPackage.YPACKAGE_IMPORT__OWNED_ELEMENT);
		}
		return ownedElement;
	}
	...
	{
		switch (featureID) {
			case YammDiagramPackage.YPACKAGE_IMPORT__OWNED_COMMENT:
				return basicSetOwnedComment(null, msgs);
			case YammDiagramPackage.YPACKAGE_IMPORT__OWNED_ELEMENT:
	...
	{
		switch (featureID) {
			case YammDiagramPackage.YPACKAGE_IMPORT__IMPORTED_PACKAGE:
				if (resolve) return getImportedPackage();
				return basicGetImportedPackage();
			case YammDiagramPackage.YPACKAGE_IMPORT__IMPORTING_NAMESPACE:
