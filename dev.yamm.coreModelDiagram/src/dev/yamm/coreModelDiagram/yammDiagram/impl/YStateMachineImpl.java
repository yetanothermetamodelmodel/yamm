...
import dev.yamm.coreModelDiagram.yammDiagram.YRunToCompletion;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#isInitialActive <em>Initial Active</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#isDesInitializer <em>Des Initializer</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getRtc <em>Rtc</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getMaxEffectsToBeProcessed <em>Max Effects To Be Processed</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getCalledOperation <em>Called Operation</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getSubvertex <em>Subvertex</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getTrAttach <em>Tr Attach</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YStateMachineImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
