...
import dev.yamm.coreModelDiagram.yammDiagram.YCreateInstanceExpression;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YCreateInstanceExpressionImpl#getClazz <em>Clazz</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YCreateInstanceExpressionImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YCreateInstanceExpressionImpl extends XExpressionImpl implements YCreateInstanceExpression
{
	...
	{
		return YammDiagramPackage.Literals.YCREATE_INSTANCE_EXPRESSION;
	}
		...
		if (clazz != null && clazz.eIsProxy()) {
			...
			if (clazz != oldClazz) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__CLAZZ, oldClazz, clazz));
			}
		}
		return clazz;
	}
	...
	public void setClazz(YClass newClazz)
	{
		...
		clazz = newClazz;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__CLAZZ, oldClazz, clazz));
	}
	...
	public JvmIdentifiableElement getFeature()
	{
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(JvmIdentifiableElement newFeature)
	{
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__FEATURE, oldFeature, feature));
	}
	...
	{
		switch (featureID) {
			case YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__CLAZZ:
				if (resolve) return getClazz();
				return basicGetClazz();
			case YammDiagramPackage.YCREATE_INSTANCE_EXPRESSION__FEATURE:
