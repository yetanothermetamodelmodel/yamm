...
import dev.yamm.coreModelDiagram.yammDiagram.YFeatureCall;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YFeatureCallImpl#isExplicitInheritanceType <em>Explicit Inheritance Type</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YFeatureCallImpl#getInheritanceType <em>Inheritance Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YFeatureCallImpl extends XFeatureCallImpl implements YFeatureCall
{
	/**
	...
	{
		return YammDiagramPackage.Literals.YFEATURE_CALL;
	}
	...
	public void setExplicitInheritanceType(boolean newExplicitInheritanceType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YFEATURE_CALL__EXPLICIT_INHERITANCE_TYPE, oldExplicitInheritanceType, explicitInheritanceType));
	}
	...
	public JvmIdentifiableElement getInheritanceType()
	{
		if (inheritanceType != null && inheritanceType.eIsProxy()) {
			...
			if (inheritanceType != oldInheritanceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammDiagramPackage.YFEATURE_CALL__INHERITANCE_TYPE, oldInheritanceType, inheritanceType));
			}
		}
	...
	public void setInheritanceType(JvmIdentifiableElement newInheritanceType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammDiagramPackage.YFEATURE_CALL__INHERITANCE_TYPE, oldInheritanceType, inheritanceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case YammDiagramPackage.YFEATURE_CALL__INHERITANCE_TYPE:
