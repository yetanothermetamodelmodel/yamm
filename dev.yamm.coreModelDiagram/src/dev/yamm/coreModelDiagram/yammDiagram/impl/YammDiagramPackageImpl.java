...
public class YammDiagramPackageImpl extends EPackageImpl implements YammDiagramPackage
{
	 ...
	 * @see dev.yamm.coreModelDiagram.yammDiagram.YammDiagramPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier)
	{
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("dev.yamm.coreModelDiagram.yammDiagram." + eClassifier.getName());
