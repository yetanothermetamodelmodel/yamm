 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getParentElement <em>Parent Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getMember <em>Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getElementImport <em>Element Import</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getImportedMember <em>Imported Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getPackageImport <em>Package Import</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getInheritedMember <em>Inherited Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getOwnedMember <em>Owned Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getOwnedRule <em>Owned Rule</em>}</li>
 *   <li>{@link dev.yamm.coreModelDiagram.yammDiagram.impl.YEnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
