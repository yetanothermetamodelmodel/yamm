...
/**
 * This is the item provider adapter for a {@link online.yamm.coreModelDiagram.yammDiagram.YMemberFeatureCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class YMemberFeatureCallItemProvider extends ItemProviderAdapter
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammDiagramPackage.Literals.YMEMBER_FEATURE_CALL__INHERITANCE_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammDiagramPackage.Literals.YMEMBER_FEATURE_CALL__EXPLICIT_INHERITANCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(YMemberFeatureCall.class)) {
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__INVALID_FEATURE_ISSUE_CODE:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__VALID_FEATURE:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__IMPLICIT_FIRST_ARGUMENT:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__EXPLICIT_OPERATION_CALL:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__EXPLICIT_STATIC:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__NULL_SAFE:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__TYPE_LITERAL:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__STATIC_WITH_DECLARING_TYPE:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__PACKAGE_FRAGMENT:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__EXPLICIT_INHERITANCE_TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__TYPE_ARGUMENTS:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__MEMBER_CALL_TARGET:
			case YammDiagramPackage.YMEMBER_FEATURE_CALL__MEMBER_CALL_ARGUMENTS:
