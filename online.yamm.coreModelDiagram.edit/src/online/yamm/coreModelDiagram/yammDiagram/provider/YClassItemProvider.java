...
/**
 * This is the item provider adapter for a {@link online.yamm.coreModelDiagram.yammDiagram.YClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class YClassItemProvider extends YElementItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammDiagramPackage.Literals.YCLASS__IS_ABSTRACT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammDiagramPackage.Literals.YCLASS__QUALIFIED_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammDiagramPackage.Literals.YCLASS__OBSERVE_QUEUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(YammDiagramPackage.Literals.YCLASS__OWNED_ATTRIBUTE);
			childrenFeatures.add(YammDiagramPackage.Literals.YCLASS__OWNED_OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(YammDiagramPackage.Literals.YCLASS__OWNED_ATTRIBUTE,
				 YammDiagramFactory.eINSTANCE.createYProperty()));

		newChildDescriptors.add
			(createChildParameter
				(YammDiagramPackage.Literals.YCLASS__OWNED_OPERATION,
