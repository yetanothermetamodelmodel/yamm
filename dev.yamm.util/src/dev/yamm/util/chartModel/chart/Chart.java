 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.util.chartModel.chart.Chart#getSeries <em>Series</em>}</li>
 *   <li>{@link dev.yamm.util.chartModel.chart.Chart#getYTitle <em>YTitle</em>}</li>
 *   <li>{@link dev.yamm.util.chartModel.chart.Chart#getXTitle <em>XTitle</em>}</li>
 *   <li>{@link dev.yamm.util.chartModel.chart.Chart#getChartId <em>Chart Id</em>}</li>
 * </ul>
 *
 * @see dev.yamm.util.chartModel.chart.ChartPackage#getChart()
 * @model
 * @generated
 */
public interface Chart extends EObject
{
	 ...
	 * The list contents are of type {@link dev.yamm.util.chartModel.chart.Series}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see dev.yamm.util.chartModel.chart.ChartPackage#getChart_Series()
	 ...
	 * @see dev.yamm.util.chartModel.chart.ChartPackage#getChart_YTitle()
	 * @model
	 * @generated
	 */
	String getYTitle();
	...
	/**
	 * Sets the value of the '{@link dev.yamm.util.chartModel.chart.Chart#getYTitle <em>YTitle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dev.yamm.util.chartModel.chart.ChartPackage#getChart_XTitle()
	 * @model
	 * @generated
	 */
	String getXTitle();
	...
	/**
	 * Sets the value of the '{@link dev.yamm.util.chartModel.chart.Chart#getXTitle <em>XTitle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dev.yamm.util.chartModel.chart.ChartPackage#getChart_ChartId()
	 * @model
	 * @generated
	 */
	String getChartId();
	...
	/**
	 * Sets the value of the '{@link dev.yamm.util.chartModel.chart.Chart#getChartId <em>Chart Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
