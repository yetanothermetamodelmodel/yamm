...
public class Table extends ViewPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		dev.yamm.util.table.TableControl control = dev.yamm.util.table.TableControl.getControl(internalViewId);
		if (control == null) // eclipse startup
		{
			control = dev.yamm.util.table.TableControl.createControl(internalViewId);
	...
	private void init()
	{
		...
		tabFolder.addCTabFolder2Listener(new CTabFolder2Adapter()
		{
			...
			public void close(CTabFolderEvent event)
			{
				...
				dev.yamm.util.table.TableControl.getControl(internalViewId).deleteTab(tabId);
			}
		});
	...
	public void dispose()
	{
		TableControl control = dev.yamm.util.table.TableControl.getControl(internalViewId);
		control.save();
