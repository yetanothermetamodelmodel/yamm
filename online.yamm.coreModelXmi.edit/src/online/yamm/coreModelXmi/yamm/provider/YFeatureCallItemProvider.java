...
/**
 * This is the item provider adapter for a {@link online.yamm.coreModelXmi.yamm.YFeatureCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class YFeatureCallItemProvider extends ItemProviderAdapter
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammPackage.Literals.YFEATURE_CALL__EXPLICIT_INHERITANCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammPackage.Literals.YFEATURE_CALL__INHERITANCE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(YFeatureCall.class)) {
			case YammPackage.YFEATURE_CALL__INVALID_FEATURE_ISSUE_CODE:
			case YammPackage.YFEATURE_CALL__VALID_FEATURE:
			case YammPackage.YFEATURE_CALL__IMPLICIT_FIRST_ARGUMENT:
			case YammPackage.YFEATURE_CALL__EXPLICIT_OPERATION_CALL:
			case YammPackage.YFEATURE_CALL__TYPE_LITERAL:
			case YammPackage.YFEATURE_CALL__PACKAGE_FRAGMENT:
			case YammPackage.YFEATURE_CALL__EXPLICIT_INHERITANCE_TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case YammPackage.YFEATURE_CALL__TYPE_ARGUMENTS:
			case YammPackage.YFEATURE_CALL__FEATURE_CALL_ARGUMENTS:
