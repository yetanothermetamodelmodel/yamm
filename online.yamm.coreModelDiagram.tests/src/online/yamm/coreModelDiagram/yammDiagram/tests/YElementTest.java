 ...
 * @generated
 */
public class YElementTest extends YObjectTest
{
	...
	{
		TestRunner.run(YElementTest.class);
	}
	...
	{
		setFixture(YammDiagramFactory.eINSTANCE.createYElement());
	}
