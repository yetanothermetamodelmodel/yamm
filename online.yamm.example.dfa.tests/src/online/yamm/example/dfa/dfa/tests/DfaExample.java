...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dfa</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DfaExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dfa"));
				DFA root = DfaFactory.eINSTANCE.createDFA();
