...
public class EStructuralFeatureToFeatureInfoMapTest extends TestCase
{
	...
	{
		setFixture((Map.Entry<EStructuralFeature, FeatureInfo>)YammDiagramFactory.eINSTANCE.create(YammDiagramPackage.Literals.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP));
	}
