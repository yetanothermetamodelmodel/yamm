...
public class ChartView extends ViewPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		online.yamm.util.chart.ChartControl control = online.yamm.util.chart.ChartControl.getControl(internalViewId);
		if (control == null) // eclipse startup
		{
			control = online.yamm.util.chart.ChartControl.createControl(internalViewId);
	...
	public void dispose()
	{
		ChartControl control = online.yamm.util.chart.ChartControl.getControl(internalViewId);
		control.save();
	...
	public void init()
	{
		...
		tabFolder.addCTabFolder2Listener(new CTabFolder2Adapter()
		{
			...
			public void close(CTabFolderEvent event)
			{
				...
				online.yamm.util.chart.ChartControl.getControl(internalViewId).deleteTab(tabId);
			}
		});
