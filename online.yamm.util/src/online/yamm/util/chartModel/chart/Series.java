 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.util.chartModel.chart.Series#getXValues <em>XValues</em>}</li>
 *   <li>{@link online.yamm.util.chartModel.chart.Series#getYValues <em>YValues</em>}</li>
 *   <li>{@link online.yamm.util.chartModel.chart.Series#getSeriesId <em>Series Id</em>}</li>
 * </ul>
 *
 * @see online.yamm.util.chartModel.chart.ChartPackage#getSeries()
 * @model
 * @generated
 */
public interface Series extends EObject
{
	 ...
	 * @see online.yamm.util.chartModel.chart.ChartPackage#getSeries_XValues()
	 ...
	 * @see online.yamm.util.chartModel.chart.ChartPackage#getSeries_YValues()
	 * @model unique="false" ordered="false"
	 * @generated
	 */
	 ...
	 * @see online.yamm.util.chartModel.chart.ChartPackage#getSeries_SeriesId()
	 * @model
	 * @generated
	 */
	String getSeriesId();
	...
	/**
	 * Sets the value of the '{@link online.yamm.util.chartModel.chart.Series#getSeriesId <em>Series Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
