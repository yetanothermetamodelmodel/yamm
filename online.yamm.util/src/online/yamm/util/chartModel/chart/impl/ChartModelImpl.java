 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.util.chartModel.chart.impl.ChartModelImpl#getTabs <em>Tabs</em>}</li>
 *   <li>{@link online.yamm.util.chartModel.chart.impl.ChartModelImpl#getViewId <em>View Id</em>}</li>
 *   <li>{@link online.yamm.util.chartModel.chart.impl.ChartModelImpl#getViewInternalId <em>View Internal Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChartModelImpl extends MinimalEObjectImpl.Container implements ChartModel
{
	...
	{
		return ChartPackage.Literals.CHART_MODEL;
	}
	...
	public EList<Tab> getTabs()
	{
		if (tabs == null)
		{
			tabs = new EObjectContainmentEList<Tab>(Tab.class, this, ChartPackage.CHART_MODEL__TABS);
		}
		return tabs;
	}
	...
	public void setViewId(String newViewId)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChartPackage.CHART_MODEL__VIEW_ID, oldViewId, viewId));
	}
	...
	public void setViewInternalId(String newViewInternalId)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChartPackage.CHART_MODEL__VIEW_INTERNAL_ID, oldViewInternalId, viewInternalId));
	}
