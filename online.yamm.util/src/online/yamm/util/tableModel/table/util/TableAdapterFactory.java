...
/**
 */
package online.yamm.util.tableModel.table.util;

import online.yamm.util.tableModel.table.*;
 ...
 * <!-- end-user-doc -->
 * @see online.yamm.util.tableModel.table.TablePackage
 * @generated
 */
public class TableAdapterFactory extends AdapterFactoryImpl
{
	...
	/**
	 * Creates a new adapter for an object of class '{@link online.yamm.util.tableModel.table.TableModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link online.yamm.util.tableModel.table.Tab <em>Tab</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link online.yamm.util.tableModel.table.Column <em>Column</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
