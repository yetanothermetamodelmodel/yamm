...
public class ModelDataProvider implements IDataProvider
{
	...
	private online.yamm.util.tableModel.table.Tab tabModel;
	
	public online.yamm.util.tableModel.table.Tab getTabModel()
	{
		return tabModel;
	}
	
	public ModelDataProvider(online.yamm.util.tableModel.table.Tab tabModel)
	{
