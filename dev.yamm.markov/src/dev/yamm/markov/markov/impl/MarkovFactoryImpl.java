...
public class MarkovFactoryImpl extends EFactoryImpl implements MarkovFactory {
	...
	public static MarkovFactory init() {
		try
		{
			MarkovFactory theMarkovFactory = (MarkovFactory)EPackage.Registry.INSTANCE.getEFactory(MarkovPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		{
			case MarkovPackage.ROBJECT: return createRObject();
			case MarkovPackage.STATE: return createState();
			case MarkovPackage.DIAGRAM: return createDiagram();
