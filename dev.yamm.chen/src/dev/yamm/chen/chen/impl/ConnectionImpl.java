 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#getRole <em>Role</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#getKardinality <em>Kardinality</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#isTotalPartizipation <em>Total Partizipation</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#isGeneralizationConnection <em>Generalization Connection</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#isGeneralization <em>Generalization</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.ConnectionImpl#isGeneralizationOrientation <em>Generalization Orientation</em>}</li>
 * </ul>
 *
 * @generated
 */
