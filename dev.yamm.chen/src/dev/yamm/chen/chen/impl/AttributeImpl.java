 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#isMultivalued <em>Multivalued</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#getKey <em>Key</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#getConnectionsToSubAttributes <em>Connections To Sub Attributes</em>}</li>
 *   <li>{@link dev.yamm.chen.chen.impl.AttributeImpl#getConnectionsToRelationOrEntity <em>Connections To Relation Or Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
