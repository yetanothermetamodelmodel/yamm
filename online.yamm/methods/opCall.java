...
//	}
	private Object opCall(Object eObject, String typeForMultiInheritance, String opName, Object inAdapterList, org.eclipse.emf.common.util.EList listOfClassesToAttachTheInAdapter, String returnVarName,  Object...args) {
		return execute.opCall.activateOperation(eObject, typeForMultiInheritance, opName, <%layer>, (org.eclipse.emf.common.util.EList<online.yamm.operations.InoutAdapter>)inAdapterList, listOfClassesToAttachTheInAdapter, returnVarName, args);
	}
