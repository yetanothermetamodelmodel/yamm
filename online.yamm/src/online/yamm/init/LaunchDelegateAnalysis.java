...
//import online.yamm.analysis.queue.MainTasks;
//import online.yamm.analysis.queue.Task;
...
//		throw new CoreException(new Status(IStatus.ERROR, online.yamm.debug.model.DebugCorePlugin.getDefault().getDescriptor().getUniqueIdentifier(), 0, message, e));
//	}
