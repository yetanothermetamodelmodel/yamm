...
//			}	
	...
	public void reset() {
		...
		if (reflectivStateChart.resourceManagement.resourceSet != null) {
			setEPackage(0, (reflectivStateChart.resourceManagement.resourceSet.getPackageRegistry()
					.getEPackage("http://www.yamm.online/coreModelXmi/Yamm")));
	 ...
	 * element at index 0 is set with http://www.yamm.online/coreModelXmi/Yamm. The following
	 * elements represent the nsURI of the current layer {@link #addNSURI()}.
	 */
	public void resetNSURIs() {
		nsURIs = new Vector<String>();
		logger.info("Setting nsURI \"http://www.yamm.online/coreModelXmi/Yamm\" for layer 0.");
		nsURIs.add("http://www.yamm.online/coreModelXmi/Yamm");
	}
