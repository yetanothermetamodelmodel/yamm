 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getParentElement <em>Parent Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getSuperClass <em>Super Class</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getOwnedOperation <em>Owned Operation</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getInsertLineSuperClass <em>Insert Line Super Class</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getInsertLineAttribute <em>Insert Line Attribute</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getInsertLineOperation <em>Insert Line Operation</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPosIsAbstract <em>Pos Is Abstract</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPosQualifiedName <em>Pos Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#getPosPackage <em>Pos Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YClassImpl#isObserveQueue <em>Observe Queue</em>}</li>
 * </ul>
 *
 * @generated
 */
