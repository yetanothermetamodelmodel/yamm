 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getParentElement <em>Parent Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getOwnedMemberPackage <em>Owned Member Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getPosQualifiedName <em>Pos Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getPosPackage <em>Pos Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPackageImpl#getInsertLineMember <em>Insert Line Member</em>}</li>
 * </ul>
 *
 * @generated
 */
