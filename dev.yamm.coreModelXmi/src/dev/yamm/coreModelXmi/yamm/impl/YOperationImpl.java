 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getClazz <em>Clazz</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosClazz <em>Pos Clazz</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosLower <em>Pos Lower</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosUpper <em>Pos Upper</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosStateMachine <em>Pos State Machine</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getPosReturnType <em>Pos Return Type</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YOperationImpl#getInsertLineParameter <em>Insert Line Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
