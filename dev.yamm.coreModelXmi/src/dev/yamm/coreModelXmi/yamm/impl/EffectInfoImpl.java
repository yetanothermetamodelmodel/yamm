...
import dev.yamm.coreModelXmi.yamm.EffectInfo;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.EffectInfoImpl#getFirstLineEffect <em>First Line Effect</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.EffectInfoImpl#getLastLineEffect <em>Last Line Effect</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.EffectInfoImpl#isIgnoreNotification <em>Ignore Notification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EffectInfoImpl extends FeatureInfoImpl implements EffectInfo
{
	...
	{
		return YammPackage.Literals.EFFECT_INFO;
	}
		...
		if (firstLineEffect != null && firstLineEffect.eIsProxy()) {
			...
			if (firstLineEffect != oldFirstLineEffect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.EFFECT_INFO__FIRST_LINE_EFFECT, oldFirstLineEffect, firstLineEffect));
			}
		}
	...
	public void setFirstLineEffect(Line newFirstLineEffect)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.EFFECT_INFO__FIRST_LINE_EFFECT, oldFirstLineEffect, firstLineEffect));
	}
	...
	public Line getLastLineEffect()
	{
		if (lastLineEffect != null && lastLineEffect.eIsProxy()) {
			...
			if (lastLineEffect != oldLastLineEffect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.EFFECT_INFO__LAST_LINE_EFFECT, oldLastLineEffect, lastLineEffect));
			}
		}
	...
	public void setLastLineEffect(Line newLastLineEffect)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.EFFECT_INFO__LAST_LINE_EFFECT, oldLastLineEffect, lastLineEffect));
	}
	...
	public void setIgnoreNotification(boolean newIgnoreNotification)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.EFFECT_INFO__IGNORE_NOTIFICATION, oldIgnoreNotification, ignoreNotification));
	}
	...
	{
		switch (featureID) {
			case YammPackage.EFFECT_INFO__FIRST_LINE_EFFECT:
				if (resolve) return getFirstLineEffect();
				return basicGetFirstLineEffect();
			case YammPackage.EFFECT_INFO__LAST_LINE_EFFECT:
				if (resolve) return getLastLineEffect();
				return basicGetLastLineEffect();
			case YammPackage.EFFECT_INFO__IGNORE_NOTIFICATION:
