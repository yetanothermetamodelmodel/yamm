...
import dev.yamm.coreModelXmi.yamm.ExecutionPhase;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getStateMachines <em>State Machines</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getStateMachineHandlers <em>State Machine Handlers</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getStateMachineHandlerCount <em>State Machine Handler Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#isConstraintsAllTrue <em>Constraints All True</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#isHasReturnParam <em>Has Return Param</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getParamCount <em>Param Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getStateExitCount <em>State Exit Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getStateExitNo <em>State Exit No</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getO <em>O</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#isObserverActive <em>Observer Active</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#isDesPhase <em>Des Phase</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getInternal <em>Internal</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getNotYetExecutedInitialActiveStatemachines <em>Not Yet Executed Initial Active Statemachines</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getDesinitStateMachine <em>Desinit State Machine</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YGlobalStateMachineImpl#getExecutionPhase <em>Execution Phase</em>}</li>
 * </ul>
 *
 * @generated
 */
