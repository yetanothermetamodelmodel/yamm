 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getParentElement <em>Parent Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getMember <em>Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getElementImport <em>Element Import</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getImportedMember <em>Imported Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getPackageImport <em>Package Import</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getInheritedMember <em>Inherited Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getOwnedMember <em>Owned Member</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YPrimitiveTypeImpl#getOwnedRule <em>Owned Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
