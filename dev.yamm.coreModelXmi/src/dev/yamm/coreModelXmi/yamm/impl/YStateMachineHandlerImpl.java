 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getState <em>State</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#isIsSuspended <em>Is Suspended</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectCount <em>Effect Count</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectNo <em>Effect No</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getCalledFrom <em>Called From</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getItsClassID <em>Its Class ID</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getOperationInstance <em>Operation Instance</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectsProcessed <em>Effects Processed</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getMaxEffectsToBeProcessed <em>Max Effects To Be Processed</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getInAdapters <em>In Adapters</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getObjectsBindedWithInoutParameters <em>Objects Binded With Inout Parameters</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getReturnVar <em>Return Var</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getNameOfRetunVar <em>Name Of Retun Var</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getObjectsToColor <em>Objects To Color</em>}</li>
 * </ul>
 *
 * @generated
 */
