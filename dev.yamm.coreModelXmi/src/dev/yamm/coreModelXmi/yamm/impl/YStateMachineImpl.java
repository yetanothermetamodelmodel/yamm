 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getName <em>Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#isInitialActive <em>Initial Active</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getRtc <em>Rtc</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getMaxEffectsToBeProcessed <em>Max Effects To Be Processed</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getCalledOperation <em>Called Operation</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getSubvertex <em>Subvertex</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getTrAttach <em>Tr Attach</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosQualifiedName <em>Pos Qualified Name</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosInitialActive <em>Pos Initial Active</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosRtc <em>Pos Rtc</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getPosMaxEffectsToBeProcessed <em>Pos Max Effects To Be Processed</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getInsertLineTransition <em>Insert Line Transition</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getInsertLineVertex <em>Insert Line Vertex</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#getInsertLineAttachment <em>Insert Line Attachment</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.YStateMachineImpl#isDesInitializer <em>Des Initializer</em>}</li>
 * </ul>
 *
 * @generated
 */
