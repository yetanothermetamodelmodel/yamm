 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.GuardInfoImpl#getFirstLineGuard <em>First Line Guard</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.GuardInfoImpl#getLastLineGuard <em>Last Line Guard</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.GuardInfoImpl#isIgnoreNotification <em>Ignore Notification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardInfoImpl extends FeatureInfoImpl implements GuardInfo
{
	...
	{
		return YammPackage.Literals.GUARD_INFO;
	}
		...
		if (firstLineGuard != null && firstLineGuard.eIsProxy()) {
			...
			if (firstLineGuard != oldFirstLineGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.GUARD_INFO__FIRST_LINE_GUARD, oldFirstLineGuard, firstLineGuard));
			}
		}
	...
	public void setFirstLineGuard(Line newFirstLineGuard)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.GUARD_INFO__FIRST_LINE_GUARD, oldFirstLineGuard, firstLineGuard));
	}
	...
	public Line getLastLineGuard()
	{
		if (lastLineGuard != null && lastLineGuard.eIsProxy()) {
			...
			if (lastLineGuard != oldLastLineGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.GUARD_INFO__LAST_LINE_GUARD, oldLastLineGuard, lastLineGuard));
			}
		}
	...
	public void setLastLineGuard(Line newLastLineGuard)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.GUARD_INFO__LAST_LINE_GUARD, oldLastLineGuard, lastLineGuard));
	}
	...
	public void setIgnoreNotification(boolean newIgnoreNotification)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.GUARD_INFO__IGNORE_NOTIFICATION, oldIgnoreNotification, ignoreNotification));
	}
	...
	{
		switch (featureID) {
			case YammPackage.GUARD_INFO__FIRST_LINE_GUARD:
				if (resolve) return getFirstLineGuard();
				return basicGetFirstLineGuard();
			case YammPackage.GUARD_INFO__LAST_LINE_GUARD:
