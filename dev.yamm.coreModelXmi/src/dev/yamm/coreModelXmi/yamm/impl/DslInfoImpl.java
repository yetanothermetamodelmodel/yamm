...
import dev.yamm.coreModelXmi.yamm.DslInfo;
import dev.yamm.coreModelXmi.yamm.FeatureInfo;
 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.DslInfoImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.DslInfoImpl#getFirstLine <em>First Line</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.impl.DslInfoImpl#getLastLine <em>Last Line</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DslInfoImpl extends MinimalEObjectImpl.Container implements DslInfo
{
	...
	{
		return YammPackage.Literals.DSL_INFO;
	}
	...
	{
		if (features == null) {
			features = new EcoreEMap<EStructuralFeature,FeatureInfo>(YammPackage.Literals.ESTRUCTURAL_FEATURE_TO_FEATURE_INFO_MAP, EStructuralFeatureToFeatureInfoMapImpl.class, this, YammPackage.DSL_INFO__FEATURES);
		}
		return features;
	}
		...
		if (firstLine != null && firstLine.eIsProxy()) {
			...
			if (firstLine != oldFirstLine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.DSL_INFO__FIRST_LINE, oldFirstLine, firstLine));
			}
		}
		return firstLine;
	}
	...
	public void setFirstLine(Line newFirstLine)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.DSL_INFO__FIRST_LINE, oldFirstLine, firstLine));
	}
	...
	public Line getLastLine()
	{
		if (lastLine != null && lastLine.eIsProxy()) {
			...
			if (lastLine != oldLastLine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.DSL_INFO__LAST_LINE, oldLastLine, lastLine));
			}
		}
		return lastLine;
	}
	...
	public void setLastLine(Line newLastLine)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.DSL_INFO__LAST_LINE, oldLastLine, lastLine));
	}
	...
	{
		switch (featureID) {
			case YammPackage.DSL_INFO__FEATURES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case YammPackage.DSL_INFO__FIRST_LINE:
				if (resolve) return getFirstLine();
				return basicGetFirstLine();
			case YammPackage.DSL_INFO__LAST_LINE:
