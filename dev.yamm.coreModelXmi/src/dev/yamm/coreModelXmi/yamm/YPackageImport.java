 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getImportedPackage <em>Imported Package</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getImportingNamespace <em>Importing Namespace</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getOwnedElement <em>Owned Element</em>}</li>
 * </ul>
 *
 * @see dev.yamm.coreModelXmi.yamm.YammPackage#getYPackageImport()
 * @model
 * @generated
 */
public interface YPackageImport extends YElement, YObject
{
	 ...
	 * @see dev.yamm.coreModelXmi.yamm.YammPackage#getYPackageImport_ImportedPackage()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getImportedPackage <em>Imported Package</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dev.yamm.coreModelXmi.yamm.YammPackage#getYPackageImport_ImportingNamespace()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getImportingNamespace <em>Importing Namespace</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dev.yamm.coreModelXmi.yamm.YammPackage#getYPackageImport_OwnedComment()
	...
	/**
	 * Sets the value of the '{@link dev.yamm.coreModelXmi.yamm.YPackageImport#getOwnedComment <em>Owned Comment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dev.yamm.coreModelXmi.yamm.YammPackage#getYPackageImport_OwnedElement()
	 * @model containment="true"
	 * @generated
	 */
