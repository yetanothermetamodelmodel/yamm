	...
	protected List getModelChildren() {
		if (isCollapsed())
		{
			...
			if (effectOrGuardColored())
				wsImage.setWorkspacePath("//online.yamm.coreModel.design/icons/statemachine/TrAttachmentCollapsedColored.gif");
			else
				wsImage.setWorkspacePath("/online.yamm.coreModel.design/icons/statemachine/TrAttachmentCollapsed.gif");	
