...
/**
 * This is the item provider adapter for a {@link dev.yamm.coreModelXmi.yamm.EffectInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammPackage.Literals.EFFECT_INFO__FIRST_LINE_EFFECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammPackage.Literals.EFFECT_INFO__LAST_LINE_EFFECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 YammPackage.Literals.EFFECT_INFO__IGNORE_NOTIFICATION,
				 true,
				 false,
				 false,
