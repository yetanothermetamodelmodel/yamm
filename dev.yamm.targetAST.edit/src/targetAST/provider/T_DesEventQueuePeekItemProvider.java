...
/**
 * This is the item provider adapter for a {@link targetAST.T_DesEventQueuePeek} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_DesEventQueuePeekItemProvider extends T_ExpLevelAItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public T_DesEventQueuePeekItemProvider(AdapterFactory adapterFactory)
	{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TDES_EVENT_QUEUE_PEEK__ARGUMENTS);
		}
	...
	/**
	 * This returns T_DesEventQueuePeek.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_DesEventQueuePeek"));
	}
	...
	{
		String label = ((T_DesEventQueuePeek)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_T_DesEventQueuePeek_type") :
			getString("_UI_T_DesEventQueuePeek_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(T_DesEventQueuePeek.class)) {
			case TargetASTPackage.TDES_EVENT_QUEUE_PEEK__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TDES_EVENT_QUEUE_PEEK__ARGUMENTS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TDES_EVENT_QUEUE_PEEK__ARGUMENTS;
