...
/**
 * This is the item provider adapter for a {@link targetAST.TargetASTRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetASTRootItemProvider 
	extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TargetASTRootItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TARGET_AST_ROOT__EXPRESSION);
		}
	...
	/**
	 * This returns TargetASTRoot.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TargetASTRoot"));
	}
	...
	public String getText(Object object) {
		String label = ((TargetASTRoot)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_TargetASTRoot_type") :
			getString("_UI_TargetASTRoot_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TargetASTRoot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TARGET_AST_ROOT__EXPRESSION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TARGET_AST_ROOT__EXPRESSION;
