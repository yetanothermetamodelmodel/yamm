...
/**
 * This is the item provider adapter for a {@link targetAST.T_ColorDFA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_ColorDFAItemProvider extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public T_ColorDFAItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TCOLOR_DFA__ID);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_ColorDFA"));
	}
	...
	public String getText(Object object) {
		String label = ((T_ColorDFA)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_T_ColorDFA_type") :
			getString("_UI_T_ColorDFA_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(T_ColorDFA.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TCOLOR_DFA__ID,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TCOLOR_DFA__ID;
