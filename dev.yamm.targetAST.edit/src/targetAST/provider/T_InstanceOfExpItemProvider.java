...
/**
 * This is the item provider adapter for a {@link targetAST.T_InstanceOfExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_InstanceOfExpItemProvider extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public T_InstanceOfExpItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTypeIsExternalPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Type Is External feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTypeIsExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_T_InstanceOfExp_typeIsExternal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_T_InstanceOfExp_typeIsExternal_feature", "_UI_T_InstanceOfExp_type"),
				 TargetASTPackage.Literals.TINSTANCE_OF_EXP__TYPE_IS_EXTERNAL,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_T_InstanceOfExp_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_T_InstanceOfExp_type_feature", "_UI_T_InstanceOfExp_type"),
				 TargetASTPackage.Literals.TINSTANCE_OF_EXP__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TINSTANCE_OF_EXP__EXPRESSION);
		}
	...
	/**
	 * This returns T_InstanceOfExp.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_InstanceOfExp"));
	}
	...
	public String getText(Object object) {
		String label = ((T_InstanceOfExp)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_T_InstanceOfExp_type") :
			getString("_UI_T_InstanceOfExp_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(T_InstanceOfExp.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TINSTANCE_OF_EXP__EXPRESSION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TINSTANCE_OF_EXP__EXPRESSION;
