...
/**
 * This is the item provider adapter for a {@link targetAST.T_DesQueueConsume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_DesQueueConsumeItemProvider extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public T_DesQueueConsumeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TDES_QUEUE_CONSUME__ARGUMENTS);
		}
	...
	/**
	 * This returns T_DesQueueConsume.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_DesQueueConsume"));
	}
	...
	public String getText(Object object) {
		String label = ((T_DesQueueConsume)object).getCastTo();
		return label == null || label.length() == 0 ?
			getString("_UI_T_DesQueueConsume_type") :
			getString("_UI_T_DesQueueConsume_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(T_DesQueueConsume.class)) {
			case TargetASTPackage.TDES_QUEUE_CONSUME__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TDES_QUEUE_CONSUME__ARGUMENTS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TDES_QUEUE_CONSUME__ARGUMENTS;
