...
/**
 * This is the item provider adapter for a {@link targetAST.T_GetInstancesOfExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_GetInstancesOfExpItemProvider extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public T_GetInstancesOfExpItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_T_GetInstancesOfExp_className_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_T_GetInstancesOfExp_className_feature", "_UI_T_GetInstancesOfExp_type"),
				 TargetASTPackage.Literals.TGET_INSTANCES_OF_EXP__CLASS_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TGET_INSTANCES_OF_EXP__EXPRESSION);
		}
	...
	/**
	 * This returns T_GetInstancesOfExp.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_GetInstancesOfExp"));
	}
	...
	public String getText(Object object) {
		String label = ((T_GetInstancesOfExp)object).getClassName();
		return label == null || label.length() == 0 ?
			getString("_UI_T_GetInstancesOfExp_type") :
			getString("_UI_T_GetInstancesOfExp_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(T_GetInstancesOfExp.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TGET_INSTANCES_OF_EXP__EXPRESSION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TGET_INSTANCES_OF_EXP__EXPRESSION;
