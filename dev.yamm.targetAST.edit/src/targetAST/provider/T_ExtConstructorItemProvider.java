...
/**
 * This is the item provider adapter for a {@link targetAST.T_ExtConstructor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class T_ExtConstructorItemProvider extends T_ExpLevelAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public T_ExtConstructorItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_T_ExtConstructor_typeQualifiedName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_T_ExtConstructor_typeQualifiedName_feature", "_UI_T_ExtConstructor_type"),
				 TargetASTPackage.Literals.TEXT_CONSTRUCTOR__TYPE_QUALIFIED_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetASTPackage.Literals.TEXT_CONSTRUCTOR__ARGUMENTS);
		}
	...
	/**
	 * This returns T_ExtConstructor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/T_ExtConstructor"));
	}
	...
	public String getText(Object object) {
		String label = ((T_ExtConstructor)object).getTypeQualifiedName();
		return label == null || label.length() == 0 ?
			getString("_UI_T_ExtConstructor_type") :
			getString("_UI_T_ExtConstructor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(T_ExtConstructor.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetASTPackage.Literals.TEXT_CONSTRUCTOR__ARGUMENTS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == TargetASTPackage.Literals.TEXT_CONSTRUCTOR__ARGUMENTS;
