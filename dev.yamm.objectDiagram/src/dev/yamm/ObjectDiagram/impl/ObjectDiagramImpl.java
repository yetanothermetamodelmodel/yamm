 ...
 * </p>
 * <ul>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getObjects <em>Objects</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getDataTypes <em>Data Types</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getStackframes <em>Stackframes</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getYammModelPath <em>Yamm Model Path</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getMetaDataPackage <em>Meta Data Package</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getTypeObjectCreate <em>Type Object Create</em>}</li>
 *   <li>{@link dev.yamm.ObjectDiagram.impl.ObjectDiagramImpl#getInitialModel <em>Initial Model</em>}</li>
 * </ul>
 *
 * @generated
 */
