 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YCommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YCommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YCommentImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YCommentImpl#getOwnedElement <em>Owned Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YCommentImpl extends YElementImpl implements YComment
{
	...
	{
		return YammPackage.Literals.YCOMMENT;
	}
	...
	public void setBody(String newBody)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YCOMMENT__BODY, oldBody, body));
	}
	...
	public EList<YElement> getAnnotatedElement()
	{
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList<YElement>(YElement.class, this, YammPackage.YCOMMENT__ANNOTATED_ELEMENT);
		}
	...
	public NotificationChain basicSetOwnedComment(YComment newOwnedComment, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YammPackage.YCOMMENT__OWNED_COMMENT, oldOwnedComment, newOwnedComment);
	...
	public void setOwnedComment(YComment newOwnedComment)
	{
		if (newOwnedComment != ownedComment) {
			...
			if (ownedComment != null)
				msgs = ((InternalEObject)ownedComment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - YammPackage.YCOMMENT__OWNED_COMMENT, null, msgs);
			if (newOwnedComment != null)
				msgs = ((InternalEObject)newOwnedComment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - YammPackage.YCOMMENT__OWNED_COMMENT, null, msgs);
			msgs = basicSetOwnedComment(newOwnedComment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YCOMMENT__OWNED_COMMENT, newOwnedComment, newOwnedComment));
	}
	...
	public EList<YElement> getOwnedElement()
	{
		if (ownedElement == null) {
			ownedElement = new EObjectContainmentEList<YElement>(YElement.class, this, YammPackage.YCOMMENT__OWNED_ELEMENT);
		}
		return ownedElement;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			case YammPackage.YCOMMENT__BODY:
				return getBody();
			case YammPackage.YCOMMENT__ANNOTATED_ELEMENT:
