 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YMemberFeatureCallImpl#getInheritanceType <em>Inheritance Type</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YMemberFeatureCallImpl#isExplicitInheritanceType <em>Explicit Inheritance Type</em>}</li>
 * </ul>
 *
 * @generated not
 */
public class YMemberFeatureCallImpl extends XMemberFeatureCallImplCustom implements YMemberFeatureCall {
	/**
	...
	protected EClass eStaticClass() {
		return YammPackage.Literals.YMEMBER_FEATURE_CALL;
	}
		...
		if (inheritanceType != null && inheritanceType.eIsProxy()) {
			...
			if (inheritanceType != oldInheritanceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YMEMBER_FEATURE_CALL__INHERITANCE_TYPE, oldInheritanceType, inheritanceType));
			}
		}
	...
	public void setInheritanceType(JvmIdentifiableElement newInheritanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YMEMBER_FEATURE_CALL__INHERITANCE_TYPE, oldInheritanceType, inheritanceType));
	}
	...
	public void setExplicitInheritanceType(boolean newExplicitInheritanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YMEMBER_FEATURE_CALL__EXPLICIT_INHERITANCE_TYPE, oldExplicitInheritanceType, explicitInheritanceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YammPackage.YMEMBER_FEATURE_CALL__INHERITANCE_TYPE:
