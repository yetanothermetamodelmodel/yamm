 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YVertexImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YVertexImpl#getIncoming <em>Incoming</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YVertexImpl extends YObjectImpl implements YVertex
{
	...
	{
		return YammPackage.Literals.YVERTEX;
	}
	...
	{
		if (outgoing == null) {
			outgoing = new EObjectResolvingEList<YTransition>(YTransition.class, this, YammPackage.YVERTEX__OUTGOING);
		}
		return outgoing;
	}
	...
	{
		if (incoming == null) {
			incoming = new EObjectResolvingEList<YTransition>(YTransition.class, this, YammPackage.YVERTEX__INCOMING);
		}
		return incoming;
	}
	...
	{
		switch (featureID) {
			case YammPackage.YVERTEX__OUTGOING:
				return getOutgoing();
			case YammPackage.YVERTEX__INCOMING:
				return getIncoming();
		}
