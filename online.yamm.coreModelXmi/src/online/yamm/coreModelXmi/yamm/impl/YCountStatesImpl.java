 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YCountStatesImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YCountStatesImpl extends XExpressionImpl implements YCountStates
{
	...
	{
		return YammPackage.Literals.YCOUNT_STATES;
	}
	...
	{
		if (parameter == null) {
			parameter = new EObjectContainmentEList<XExpression>(XExpression.class, this, YammPackage.YCOUNT_STATES__PARAMETER);
		}
		return parameter;
	}
