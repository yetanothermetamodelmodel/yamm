 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YElementImportImpl#getImportedElement <em>Imported Element</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YElementImportImpl#getImportingNamespace <em>Importing Namespace</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YElementImportImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YElementImportImpl#getOwnedElement <em>Owned Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YElementImportImpl extends YElementImpl implements YElementImport
{
	...
	{
		return YammPackage.Literals.YELEMENT_IMPORT;
	}
		...
		if (importedElement != null && importedElement.eIsProxy()) {
			...
			if (importedElement != oldImportedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YELEMENT_IMPORT__IMPORTED_ELEMENT, oldImportedElement, importedElement));
			}
		}
	...
	public void setImportedElement(YPackageableElement newImportedElement)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YELEMENT_IMPORT__IMPORTED_ELEMENT, oldImportedElement, importedElement));
	}
	...
	public YNamespace getImportingNamespace()
	{
		if (importingNamespace != null && importingNamespace.eIsProxy()) {
			...
			if (importingNamespace != oldImportingNamespace) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YELEMENT_IMPORT__IMPORTING_NAMESPACE, oldImportingNamespace, importingNamespace));
			}
		}
	...
	public void setImportingNamespace(YNamespace newImportingNamespace)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YELEMENT_IMPORT__IMPORTING_NAMESPACE, oldImportingNamespace, importingNamespace));
	}
	...
	public NotificationChain basicSetOwnedComment(YComment newOwnedComment, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YammPackage.YELEMENT_IMPORT__OWNED_COMMENT, oldOwnedComment, newOwnedComment);
	...
	public void setOwnedComment(YComment newOwnedComment)
	{
		if (newOwnedComment != ownedComment) {
			...
			if (ownedComment != null)
				msgs = ((InternalEObject)ownedComment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - YammPackage.YELEMENT_IMPORT__OWNED_COMMENT, null, msgs);
			if (newOwnedComment != null)
				msgs = ((InternalEObject)newOwnedComment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - YammPackage.YELEMENT_IMPORT__OWNED_COMMENT, null, msgs);
			msgs = basicSetOwnedComment(newOwnedComment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YELEMENT_IMPORT__OWNED_COMMENT, newOwnedComment, newOwnedComment));
	}
	...
	public EList<YElement> getOwnedElement()
	{
		if (ownedElement == null) {
			ownedElement = new EObjectContainmentEList<YElement>(YElement.class, this, YammPackage.YELEMENT_IMPORT__OWNED_ELEMENT);
		}
		return ownedElement;
	}
	...
	{
		switch (featureID) {
			case YammPackage.YELEMENT_IMPORT__IMPORTED_ELEMENT:
				if (resolve) return getImportedElement();
				return basicGetImportedElement();
			case YammPackage.YELEMENT_IMPORT__IMPORTING_NAMESPACE:
