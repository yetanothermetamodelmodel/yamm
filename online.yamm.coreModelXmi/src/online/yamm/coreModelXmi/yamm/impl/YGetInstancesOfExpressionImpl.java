 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YGetInstancesOfExpressionImpl#getClazz <em>Clazz</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YGetInstancesOfExpressionImpl extends XExpressionImpl implements YGetInstancesOfExpression
{
	...
	{
		return YammPackage.Literals.YGET_INSTANCES_OF_EXPRESSION;
	}
		...
		if (clazz != null && clazz.eIsProxy()) {
			...
			if (clazz != oldClazz) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YGET_INSTANCES_OF_EXPRESSION__CLAZZ, oldClazz, clazz));
			}
		}
		return clazz;
	}
	...
	public void setClazz(YClass newClazz)
	{
		...
		clazz = newClazz;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YGET_INSTANCES_OF_EXPRESSION__CLAZZ, oldClazz, clazz));
	}
	...
	{
		switch (featureID) {
			case YammPackage.YGET_INSTANCES_OF_EXPRESSION__CLAZZ:
