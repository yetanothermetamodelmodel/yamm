 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getEffects <em>Effects</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getGuardStringRep <em>Guard String Rep</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getPosTransition <em>Pos Transition</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getPosQualifiedName <em>Pos Qualified Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YTrAttachmentImpl#getInsertEffect <em>Insert Effect</em>}</li>
 * </ul>
 *
 * @generated
 */
