...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>YPseudostate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getName <em>Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getPosObjectID <em>Pos Object ID</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getPosName <em>Pos Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getPosQualifiedName <em>Pos Qualified Name</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getInsertOutgoing <em>Insert Outgoing</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YPseudostateImpl#getInsertIncoming <em>Insert Incoming</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YPseudostateImpl extends YElementImpl implements YPseudostate
{
	/**
	...
	{
		return YammPackage.Literals.YPSEUDOSTATE;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName()
	{
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, YammPackage.YPSEUDOSTATE__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	{
		if (outgoing == null) {
			outgoing = new EObjectResolvingEList<YTransition>(YTransition.class, this, YammPackage.YPSEUDOSTATE__OUTGOING);
		}
		return outgoing;
	}
	...
	{
		if (incoming == null) {
			incoming = new EObjectResolvingEList<YTransition>(YTransition.class, this, YammPackage.YPSEUDOSTATE__INCOMING);
		}
		return incoming;
	}
	...
	public void setQualifiedName(String newQualifiedName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__QUALIFIED_NAME, oldQualifiedName, qualifiedName));
	}
	...
	public SingleLinePropertyInfo getPosObjectID()
	{
		if (posObjectID != null && posObjectID.eIsProxy()) {
			...
			if (posObjectID != oldPosObjectID) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YPSEUDOSTATE__POS_OBJECT_ID, oldPosObjectID, posObjectID));
			}
		}
		return posObjectID;
	}
	...
	public void setPosObjectID(SingleLinePropertyInfo newPosObjectID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__POS_OBJECT_ID, oldPosObjectID, posObjectID));
	}
	...
	public SingleLinePropertyInfo getPosName()
	{
		if (posName != null && posName.eIsProxy()) {
			...
			if (posName != oldPosName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YPSEUDOSTATE__POS_NAME, oldPosName, posName));
			}
		}
		return posName;
	}
	...
	public void setPosName(SingleLinePropertyInfo newPosName)
	{
		...
		posName = newPosName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__POS_NAME, oldPosName, posName));
	}
	...
	public SingleLinePropertyInfo getPosQualifiedName()
	{
		if (posQualifiedName != null && posQualifiedName.eIsProxy()) {
			...
			if (posQualifiedName != oldPosQualifiedName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YPSEUDOSTATE__POS_QUALIFIED_NAME, oldPosQualifiedName, posQualifiedName));
			}
		}
	...
	public void setPosQualifiedName(SingleLinePropertyInfo newPosQualifiedName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__POS_QUALIFIED_NAME, oldPosQualifiedName, posQualifiedName));
	}
	...
	public void setInsertOutgoing(int newInsertOutgoing)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__INSERT_OUTGOING, oldInsertOutgoing, insertOutgoing));
	}
	...
	public void setInsertIncoming(int newInsertIncoming)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YPSEUDOSTATE__INSERT_INCOMING, oldInsertIncoming, insertIncoming));
	}
	...
	{
		switch (featureID) {
			case YammPackage.YPSEUDOSTATE__NAME:
				return getName();
			case YammPackage.YPSEUDOSTATE__OUTGOING:
				return getOutgoing();
			case YammPackage.YPSEUDOSTATE__INCOMING:
				return getIncoming();
			case YammPackage.YPSEUDOSTATE__QUALIFIED_NAME:
				return getQualifiedName();
			case YammPackage.YPSEUDOSTATE__POS_OBJECT_ID:
				if (resolve) return getPosObjectID();
				return basicGetPosObjectID();
			case YammPackage.YPSEUDOSTATE__POS_NAME:
				if (resolve) return getPosName();
				return basicGetPosName();
			case YammPackage.YPSEUDOSTATE__POS_QUALIFIED_NAME:
				if (resolve) return getPosQualifiedName();
				return basicGetPosQualifiedName();
			case YammPackage.YPSEUDOSTATE__INSERT_OUTGOING:
				return getInsertOutgoing();
			case YammPackage.YPSEUDOSTATE__INSERT_INCOMING:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == YNamedElement.class) {
			switch (derivedFeatureID) {
				case YammPackage.YPSEUDOSTATE__NAME: return YammPackage.YNAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == YVertex.class) {
			switch (derivedFeatureID) {
				case YammPackage.YPSEUDOSTATE__OUTGOING: return YammPackage.YVERTEX__OUTGOING;
				case YammPackage.YPSEUDOSTATE__INCOMING: return YammPackage.YVERTEX__INCOMING;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == YNamedElement.class) {
			switch (baseFeatureID) {
				case YammPackage.YNAMED_ELEMENT__NAME: return YammPackage.YPSEUDOSTATE__NAME;
				default: return -1;
			}
		}
		if (baseClass == YVertex.class) {
			switch (baseFeatureID) {
				case YammPackage.YVERTEX__OUTGOING: return YammPackage.YPSEUDOSTATE__OUTGOING;
				case YammPackage.YVERTEX__INCOMING: return YammPackage.YPSEUDOSTATE__INCOMING;
				default: return -1;
			}
		}
