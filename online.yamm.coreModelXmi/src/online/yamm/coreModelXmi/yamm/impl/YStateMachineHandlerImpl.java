 ...
 * </p>
 * <ul>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getState <em>State</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#isIsSuspended <em>Is Suspended</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectCount <em>Effect Count</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectNo <em>Effect No</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getCalledFrom <em>Called From</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getItsClassID <em>Its Class ID</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getOperationInstance <em>Operation Instance</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getEffectsProcessed <em>Effects Processed</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getMaxEffectsToBeProcessed <em>Max Effects To Be Processed</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getInAdapters <em>In Adapters</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getObjectsBindedWithInoutParameters <em>Objects Binded With Inout Parameters</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getReturnVar <em>Return Var</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getNameOfRetunVar <em>Name Of Retun Var</em>}</li>
 *   <li>{@link online.yamm.coreModelXmi.yamm.impl.YStateMachineHandlerImpl#getObjectsToColor <em>Objects To Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YStateMachineHandlerImpl extends YObjectImpl implements YStateMachineHandler
{
	...
	{
		return YammPackage.Literals.YSTATE_MACHINE_HANDLER;
	}
		...
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YSTATE_MACHINE_HANDLER__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public void setState(YVertex newState)
	{
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__STATE, oldState, state));
	}
	...
	public YTransition getTransition()
	{
		if (transition != null && transition.eIsProxy()) {
			...
			if (transition != oldTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YSTATE_MACHINE_HANDLER__TRANSITION, oldTransition, transition));
			}
		}
		return transition;
	}
	...
	public void setTransition(YTransition newTransition)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__TRANSITION, oldTransition, transition));
	}
	...
	public void setIsSuspended(boolean newIsSuspended)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__IS_SUSPENDED, oldIsSuspended, isSuspended));
	}
	...
	public void setEffectCount(int newEffectCount)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__EFFECT_COUNT, oldEffectCount, effectCount));
	}
	...
	public void setEffectNo(int newEffectNo)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__EFFECT_NO, oldEffectNo, effectNo));
	}
	...
	public YStateMachine getStateMachine()
	{
		if (stateMachine != null && stateMachine.eIsProxy()) {
			...
			if (stateMachine != oldStateMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YSTATE_MACHINE_HANDLER__STATE_MACHINE, oldStateMachine, stateMachine));
			}
		}
		return stateMachine;
	}
	...
	public void setStateMachine(YStateMachine newStateMachine)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__STATE_MACHINE, oldStateMachine, stateMachine));
	}
	...
	public void setEffect(String newEffect)
	{
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__EFFECT, oldEffect, effect));
	}
	...
	public YStateMachineHandler getCalledFrom()
	{
		if (calledFrom != null && calledFrom.eIsProxy()) {
			...
			if (calledFrom != oldCalledFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YSTATE_MACHINE_HANDLER__CALLED_FROM, oldCalledFrom, calledFrom));
			}
		}
		return calledFrom;
	}
	...
	public void setCalledFrom(YStateMachineHandler newCalledFrom)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__CALLED_FROM, oldCalledFrom, calledFrom));
	}
	...
	public void setItsClassID(String newItsClassID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__ITS_CLASS_ID, oldItsClassID, itsClassID));
	}
	...
	public EObject getOperationInstance()
	{
		if (operationInstance != null && operationInstance.eIsProxy()) {
			...
			if (operationInstance != oldOperationInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YammPackage.YSTATE_MACHINE_HANDLER__OPERATION_INSTANCE, oldOperationInstance, operationInstance));
			}
		}
	...
	public void setOperationInstance(EObject newOperationInstance)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__OPERATION_INSTANCE, oldOperationInstance, operationInstance));
	}
	...
	public void setEffectsProcessed(int newEffectsProcessed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__EFFECTS_PROCESSED, oldEffectsProcessed, effectsProcessed));
	}
	...
	public void setMaxEffectsToBeProcessed(int newMaxEffectsToBeProcessed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__MAX_EFFECTS_TO_BE_PROCESSED, oldMaxEffectsToBeProcessed, maxEffectsToBeProcessed));
	}
	...
	{
		if (inAdapters == null) {
			inAdapters = new EDataTypeUniqueEList<Object>(Object.class, this, YammPackage.YSTATE_MACHINE_HANDLER__IN_ADAPTERS);
		}
		return inAdapters;
	}
	...
	public void setObjectsBindedWithInoutParameters(Object newObjectsBindedWithInoutParameters)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__OBJECTS_BINDED_WITH_INOUT_PARAMETERS, oldObjectsBindedWithInoutParameters, objectsBindedWithInoutParameters));
	}
	...
	public void setReturnVar(Object newReturnVar)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__RETURN_VAR, oldReturnVar, returnVar));
	}
	...
	public void setNameOfRetunVar(String newNameOfRetunVar)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__NAME_OF_RETUN_VAR, oldNameOfRetunVar, nameOfRetunVar));
	}
	...
	public void setObjectsToColor(Object newObjectsToColor)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YammPackage.YSTATE_MACHINE_HANDLER__OBJECTS_TO_COLOR, oldObjectsToColor, objectsToColor));
	}
	...
	{
		switch (featureID) {
			case YammPackage.YSTATE_MACHINE_HANDLER__STATE:
				if (resolve) return getState();
				return basicGetState();
			case YammPackage.YSTATE_MACHINE_HANDLER__TRANSITION:
			...
			case YammPackage.YSTATE_MACHINE_HANDLER__OPERATION_INSTANCE:
